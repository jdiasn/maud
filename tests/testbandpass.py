...
f1 = window_1Dbandpass(data=Y, lshortpass=35, llongpass=8, t=x,
                       method=method, axis=0, parallel=False)
f2 = window_1Dbandpass(data=Y, lshortpass=90, llongpass=40, t=x,
                       method=method, axis=0, parallel=False)
f3 = window_1Dbandpass(data=Y, lshortpass=90, llongpass=8, t=x,
                       method=method, axis=0, parallel=False)
